...
const UserSearchResult = _i1.ObjectTypeDefinitionNode(
  name: _i1.NameNode(value: 'UserSearchResult'),
  directives: [],
  interfaces: [],
  fields: [
    _i1.FieldDefinitionNode(
...
const CallSignalType = _i1.EnumTypeDefinitionNode(
  ...
  values: [
    ...
    _i1.EnumValueDefinitionNode(
      name: _i1.NameNode(value: 'ICE_CANDIDATE'),
      directives: [],
    ),
    _i1.EnumValueDefinitionNode(
      name: _i1.NameNode(value: 'HANGUP'),
      directives: [],
    ),
  ],
);
const CallSignal = _i1.ObjectTypeDefinitionNode(
  name: _i1.NameNode(value: 'CallSignal'),
  directives: [],
  interfaces: [],
  fields: [
    _i1.FieldDefinitionNode(
